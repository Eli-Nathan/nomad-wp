...
if ( ! class_exists( 'Kata_Plus_Blog_Posts' ) ) {
	class Kata_Plus_Blog_Posts extends Widget_Base {
		...
		public function get_style_depends() {
			return [ 'kata-plus-owl-carousel-css', 'kata-plus-owl', 'kata-plus-blog-posts', 'zilla-likes' ];
		}

		public function get_script_depends() {
			return [ 'kata-plus-owl-carousel-js', 'kata-plus-owlcarousel-thumbs', 'kata-plus-owl', 'zilla-likes', 'kata-blog-posts' ];
		}
		...
		protected function register_controls() {
			...
			$this->add_control(
				...
				[
					...
					'type'             => 'kata_styler',
					'selectors'        => Kata_Styler::selectors( '.kata-blog-posts .ktbl-sortoptions' ),
				]
			);
			$this->add_control(
				'sort_by_items',
				[
					...
					'type'             => 'kata_styler',
					'selectors'        => Kata_Styler::selectors( '.kata-blog-posts .ktbl-sortoptions option' ),
					'separator' => 'after',
				]
			);
			$this->add_control(
				...
				[
					...
					'type'             => 'kata_styler',
					'selectors'        => Kata_Styler::selectors( '.ktbl-load-more-wrap' ),
				]
			);
			$this->add_control(
				...
				[
					'label'            => esc_html__( 'Load More Button', 'kata-plus' ),
					'type'             => 'kata_styler',
					'selectors'        => Kata_Styler::selectors( '.ktbl-load-more' ),
				]
			);
			$this->end_controls_section();
			...
			$this->add_control(
				...
				[
					'label'            => esc_html__( 'Tags icon', 'kata-plus' ),
					'type'             => 'kata_styler',
					'selectors'        => Kata_Styler::selectors( '.kata-first-post .kata-tags-links .kata-icon' ),
				]
			);
			$this->add_control(
			...
			$this->add_control(
				...
				[
					'label'            => __( 'Slider Left Arrow Wrapper', 'kata-plus' ),
					'type'             => 'kata_styler',
			...
			$this->add_control(
				...
				[
					'label'            => __( 'Slider Right Arrow Wrapper', 'kata-plus' ),
					'type'             => 'kata_styler',
