...
class Kata_Plus_Single_Testimonial_Widget {
	/**
	 * Constructor.
	 *
	 * @since   1.0.0
	...
	private function register_widget() {
		Plugin::instance()->widgets_manager->register_widget_type( new Kata_Plus_Single_Testimonial() );
	}
...
new Kata_Plus_Single_Testimonial_Widget();
